...
import { getJobs, getJobsByQuery, getTitleAndLocation } from '@/actions/Job';
...
const Jobs = () => {
    ...
    useEffect(() => {
        if (inView && hasNextPage && !jobLoading) {
            dispatch(getJobsByQuery({
                keywords: keyword,
                location: location1,
                salary,
                page: currentPage + 1,   // ← pass next page to your action
            }));
        }
    }, [inView]);
    // ─────────────────────────────────────────────────────────────────────────
    ...
    useEffect(() => {
        ...
        dispatch(getJobsByQuery({ keywords: keyword, location: location1, salary, page: 1 }));
    }, []);
